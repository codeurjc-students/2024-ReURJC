...
public class MoodleControllerTests {
    ...
    void testMiEndpoint_ValidData_NewMark() throws Exception {
        ...
        assertEquals(URI.create("/api/events/10"), response.getHeaders().getLocation()); // Verificar la URI
    ...
    void testMiEndpoint_ValidData_UpdateMark() throws Exception {
        ...
        assertEquals(HttpStatus.CREATED, response.getStatusCode());
        assertEquals(URI.create("/api/events/10"), response.getHeaders().getLocation());
