...
public class DataLoader {
    ...
    public void init() throws IOException, URISyntaxException {
        ...
        User user1 = new User(1L, "John", "Doe", "Smith", "12345678A", "mariscalalonso16@icloud.com",
                passwordEncoder.encode("123"));
        User user2 = new User(2L, "Jane", "Doe", "Smith", "87654321B", "yaovi@icloud.com",
                passwordEncoder.encode("123"));
        User user3 = new User(3L, "lolazo", "Doe", "Smith", "87654321B", "yaovi123@icloud.com",
                passwordEncoder.encode("123"));
        User user4 = new User(4L, "lolazo123", "Doe", "Smith", "87654321B", "yaovi1234@icloud.com",
                passwordEncoder.encode("123"));
        ...
        eventService.save(new BecomeCandidateEvent("Escolar", "Postularse como candidato",
                "Porque la democracia nunca ha sido más decisiva que nunca", "2025-11-07"));
        eventService.save(new VoteDelegateEvent("Escolar", "Voto a delegados",
                "Vota a tus compañeros, porque Demo- de democracia no es una fase beta, sino que el poder está en tus manos",
                "2025-11-07"));
